...
useful.quickfits(normalized_coronagraphic_PSF, dir=result_dir, name = "Normalized_coronagraphic_PSF")
...
testbed_1DM = instr.concatenate_os([pup_round, DM3, corono], ["entrancepupil","DM3", "corono"])
...
testbed_1DM_romanpup = instr.concatenate_os([pup_roman, DM3, corono], ["entrancepupil","DM3", "corono"])
...
print("number of actuators in each DMs: ", testbed_1DM_romanpup.number_of_acts_in_DMs)
...
Coronaconfig.update(
    {'filename_instr_apod': "ClearPlane"})
corono_thd = instr.coronagraph(modelconfig, Coronaconfig, model_dir=model_dir)

# and then just concatenate
thd2 = instr.concatenate_os([pup_round, DM1, DM3, corono_thd], ["entrancepupil","DM1", "DM3", "corono"])
...
# DMconfig["DM1_z_position"] = "-26.9e-2"# m
...
# testbed_3DM = instr.concatenate_os([pup_roman, DM1, DM3,pupil_inbetween_DM, DMnew, corono], ["entrancepupil","DM1", "DM3","pupil_inbetween_DM","DMnew", "corono"])
